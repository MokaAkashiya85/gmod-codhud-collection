CoDHUD.RegisterHUD( "waw", "#CoDHUD.Type.waw", true )
...
if CLIENT then
	killicon.Add("CoDHUD_WaW_Suicide", hudtype .. "/killfeed/death_suicide.png", Color(255, 255, 255, 0))
	killicon.Add("CoDHUD_WaW_Headshot", hudtype .. "/killfeed/death_headshot.png", Color(255, 255, 255, 0))
end
...
CoDHUD.Factions[hudtype] = {
	["american"] = {
		...
		killfeedcol = Color(255*0.5, 255*0.5, 255*0.5),
		glow = Color(255*0.5, 255*0.5, 255*0.5),
	...
	["soviet"] = {
		...
		killfeedcol = Color(255*0.52, 255*0.28, 255*0.28),
	...
	["german"] = {
		...
		killfeedcol = Color(255*0.65, 255*0.57, 255*0.41),
		glow = Color(255*0.65, 255*0.57, 255*0.41),
		scoremat = hudtype .. "/hud/scorebar_german.png",
		order = 3
	},
	["japan"] = {
		...
		killfeedcol = Color(255*0.52, 255*0.28, 255*0.28),
		glow = Color(255*0.52, 255*0.28, 255*0.28),
		scoremat = hudtype .. "/hud/scorebar_japan.png",
		order = 4
	},
}
...
CoDHUD.Gamemodes[hudtype].Hints = {
    ...
    ["twar"] = "WAW_OBJECTIVES_TWAR_HINT", -- War
}
...
local function DrawSqueezedScore(val, x, y, alpha)
	...
	local runX = curX
	runX = runX + DrawComponent(partPlus, "WaW_Score_Plus", runX, y) + gapPlus

	for i = 1, #s_val do
		local char = s_val:sub(i, i)
		local w    = DrawComponent(char, "WaW_Score_Main", runX, y)
		if i < #s_val then
			local gap = (char == "1") and CoDHUD_SX(-0) or CoDHUD_SX(-0)
			runX = runX + w + gap
		end
...
CoDHUD[hudtype].LevelData = {
	nameprefix = "WAW_",
	materialpath = "waw/ranks/rank_", -- For icons; followed by the "rank icon" path.
}
...
CoDHUD[hudtype].Levels = {
	...
	[1] = { "pvt2", 30, 90, "RANK_PVT_FULL2", "rank_pvt2", 120 },
	[2] = { "pvt3", 120, 150, "RANK_PVT_FULL3", "rank_pvt3", 270 },
	[3] = { "pfc1", 270, 210, "RANK_PFC_FULL", "rank_pfc1", 480 },
	[4] = { "pfc2", 480, 270, "RANK_PFC_FULL2", "rank_pfc2", 750 },
	[5] = { "pfc3", 750, 330, "RANK_PFC_FULL3", "rank_pfc3", 1080 },
	[6] = { "cpl1", 1080, 390, "RANK_CPL_FULL", "rank_cpl1", 1470 },
	[7] = { "cpl2", 1470, 450, "RANK_CPL_FULL2", "rank_cpl2", 1920 },
	[8] = { "cpl3", 1920, 510, "RANK_CPL_FULL3", "rank_cpl3", 2430 },
	[9] = { "sgt1", 2430, 570, "RANK_SGT_FULL", "rank_sgt1", 3000 },
	[10] = { "sgt2", 3000, 630, "RANK_SGT_FULL2", "rank_sgt2", 3630 },
	[11] = { "sgt3", 3630, 690, "RANK_SGT_FULL3", "rank_sgt3", 4320 },
	[12] = { "ssgt1", 4320, 750, "RANK_SSGT_FULL", "rank_ssgt1", 5070 },
	[13] = { "ssgt2", 5070, 810, "RANK_SSGT_FULL2", "rank_ssgt2", 5880 },
	[14] = { "ssgt3", 5880, 870, "RANK_SSGT_FULL3", "rank_ssgt3", 6750 },
	[15] = { "ssgt4", 6750, 930, "RANK_SSGT_FULL4", "rank_ssgt4", 7680 },
	[16] = { "gysgt1", 7680, 990, "RANK_GYSGT_FULL", "rank_gysgt1", 8670 },
	[17] = { "gysgt2", 8670, 1050, "RANK_GYSGT_FULL2", "rank_gysgt2", 9720 },
	[18] = { "gysgt3", 9720, 1110, "RANK_GYSGT_FULL3", "rank_gysgt3", 10830 },
	[19] = { "gysgt4", 10830, 1170, "RANK_GYSGT_FULL4", "rank_gysgt4", 12000 },
	[20] = { "msgt1", 12000, 1250, "RANK_MSGT_FULL", "rank_msgt1", 13250 },
	[21] = { "msgt2", 13250, 1330, "RANK_MSGT_FULL2", "rank_msgt2", 14580 },
	[22] = { "msgt3", 14580, 1410, "RANK_MSGT_FULL3", "rank_msgt3", 15990 },
	[23] = { "msgt4", 15990, 1490, "RANK_MSGT_FULL4", "rank_msgt4", 17480 },
	[24] = { "sgtm1", 17480, 1570, "RANK_SGTM_FULL", "rank_sgtm1", 19050 },
	[25] = { "sgtm2", 19050, 1650, "RANK_SGTM_FULL2", "rank_sgtm2", 20700 },
	[26] = { "sgtm3", 20700, 1730, "RANK_SGTM_FULL3", "rank_sgtm3", 22430 },
	[27] = { "sgtm4", 22430, 1810, "RANK_SGTM_FULL4", "rank_sgtm4", 24240 },
	[28] = { "2ndlt1", 24240, 1890, "RANK_2NDLT_FULL", "rank_2ndlt1", 26130 },
	[29] = { "2ndlt2", 26130, 1970, "RANK_2NDLT_FULL2", "rank_2ndlt2", 28100 },
	[30] = { "2ndlt3", 28100, 2050, "RANK_2NDLT_FULL3", "rank_2ndlt3", 30150 },
	[31] = { "2ndlt4", 30150, 2130, "RANK_2NDLT_FULL4", "rank_2ndlt4", 32280 },
	[32] = { "1stlt1", 32280, 2210, "RANK_1STLT_FULL", "rank_1stlt1", 34490 },
	[33] = { "1stlt2", 34490, 2290, "RANK_1STLT_FULL2", "rank_1stlt2", 36780 },
	[34] = { "1stlt3", 36780, 2370, "RANK_1STLT_FULL3", "rank_1stlt3", 39150 },
	[35] = { "1stlt4", 39150, 2450, "RANK_1STLT_FULL4", "rank_1stlt4", 41600 },
	[36] = { "capt1", 41600, 2530, "RANK_CAPT_FULL", "rank_capt1", 44130 },
	[37] = { "capt2", 44130, 2610, "RANK_CAPT_FULL2", "rank_capt2", 46740 },
	[38] = { "capt3", 46740, 2690, "RANK_CAPT_FULL3", "rank_capt3", 49430 },
	[39] = { "capt4", 49430, 2770, "RANK_CAPT_FULL4", "rank_capt4", 52200 },
	[40] = { "maj1", 52200, 2870, "RANK_MAJ_FULL", "rank_maj1", 55070 },
	[41] = { "maj2", 55070, 2970, "RANK_MAJ_FULL2", "rank_maj2", 58040 },
	[42] = { "maj3", 58040, 3070, "RANK_MAJ_FULL3", "rank_maj3", 61110 },
	[43] = { "maj4", 61110, 3170, "RANK_MAJ_FULL4", "rank_maj4", 64280 },
	[44] = { "ltcol1", 64280, 3270, "RANK_LTCOL_FULL", "rank_ltcol1", 67550 },
	[45] = { "ltcol2", 67550, 3370, "RANK_LTCOL_FULL2", "rank_ltcol2", 70920 },
	[46] = { "ltcol3", 70920, 3470, "RANK_LTCOL_FULL3", "rank_ltcol3", 74390 },
	[47] = { "ltcol4", 74390, 3570, "RANK_LTCOL_FULL4", "rank_ltcol4", 77960 },
	[48] = { "col1", 77960, 3670, "RANK_COL_FULL", "rank_col1", 81630 },
	[49] = { "col2", 81630, 3770, "RANK_COL_FULL2", "rank_col2", 85400 },
	[50] = { "col3", 85400, 3870, "RANK_COL_FULL3", "rank_col3", 89270 },
	[51] = { "col4", 89270, 3970, "RANK_COL_FULL4", "rank_col4", 93240 },
	[52] = { "bgen1", 93240, 4070, "RANK_BGEN_FULL", "rank_bgen1", 97310 },
	[53] = { "bgen2", 97310, 4170, "RANK_BGEN_FULL2", "rank_bgen2", 101480 },
	[54] = { "bgen3", 101480, 4270, "RANK_BGEN_FULL3", "rank_bgen3", 105750 },
	[55] = { "bgen4", 105750, 4370, "RANK_BGEN_FULL4", "rank_bgen4", 110120 },
	[56] = { "majgen1", 110120, 4470, "RANK_MAJGEN_FULL", "rank_majgen1", 114590 },
	[57] = { "majgen2", 114590, 4570, "RANK_MAJGEN_FULL2", "rank_majgen2", 119160 },
	[58] = { "majgen3", 119160, 4670, "RANK_MAJGEN_FULL3", "rank_majgen3", 123830 },
	[59] = { "majgen4", 123830, 4770, "RANK_MAJGEN_FULL4", "rank_majgen4", 128600 },
	[60] = { "ltgen1", 128600, 4870, "RANK_LTGEN_FULL", "rank_ltgen1", 133470 },
	[61] = { "ltgen2", 133470, 4970, "RANK_LTGEN_FULL2", "rank_ltgen2", 138440 },
	[62] = { "ltgen3", 138440, 5070, "RANK_LTGEN_FULL3", "rank_ltgen3", 143510 },
	[63] = { "ltgen4", 143510, 5170, "RANK_LTGEN_FULL4", "rank_ltgen4", 148680 },
	[64] = { "comm1", 148680, 5270, "RANK_COMM_FULL", "rank_comm1", 153950 }
}
...
local function challengecomplete( ... )
    ...
    CoDHUD_HeaderQueue.Push({
		...
		holdTime = 4,
        fonts = {
            pri = "WaW_ChalHeader_Pri",
            sec = "WaW_ChalHeader_Sec",
            shd = "WaW_ChalHeader_Shd"
        },
		align = align or nil
    })
end
...
local function rs_timer( ... )
	...
	if disp > 0 then
		...
		cam.PushModelMatrix(tMat)
			draw.SimpleTextOutlined( disptext, "WaW_RS_Timer", tx, ty, Color(255,255,100), 1, 1, outlined and 1 or 0, Color(0,0,0) )
		cam.PopModelMatrix()

		draw.SimpleTextOutlined( "#MW2_MP_MATCH_STARTING_IN", "WaW_RS_S_Pri", tx, ty + syo, Color(255,255,255), 1, 1, outlined and 1 or 0, Color(0,0,0) )
	end
end
...
local function killfeed( ... )
    ...
    for i = #KillFeed, 1, -1 do
        ...
        if data.type == "kill" then
			...
			local cls = data.isHeadshot and "CoDHUD_WaW_Headshot" or data.weaponClass
...
-- local debugpic = true
local debugpicture = Material("debugref/waw.png", "smooth")
...
local function scorebar(data)
	...
	local bgmat = Material(hudtype .. "/hud/scorebar_backdrop.png", "smooth")
	
	if losing then 
		losingarrowoffset = CoDHUD_SY(40)
	end
    ...
    DrawSqueezedText(clientKills * 10,   "WaW_Font", CoDHUD_S(S_CFG.X), cky, white, S_CFG.SQUEEZE, S_CFG.SQUEEZE_ONE, 2, S_CFG.SQUEEZE_ONE_BEFORE, S_CFG.OUTLINE_W)
    DrawSqueezedText(topEnemyKills * 10, "WaW_Font", CoDHUD_S(S_CFG.X), eky, white, S_CFG.SQUEEZE, S_CFG.SQUEEZE_ONE, 2, S_CFG.SQUEEZE_ONE_BEFORE, S_CFG.OUTLINE_W)
...
local function scoreboard( ... )
	...
	local function DrawPlayerRow(ply, lp, x, y, w, h, barRight, bgCol)
		...
		-- draw.SimpleTextOutlined(" - " .. ping, "WaW_Scoreboard_Text", barRight - CoDHUD_S(CFG.OFF_DEATHS) + boxSize + CoDHUD_S(CFG.PING_BAR_W) + CoDHUD_S(10), y + (h / 2), Color(255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, outlined and 1 or 0, Color(0, 0, 0))
	end
	...
	render.SetScissorRect(0, viewportTop, ScrW(), viewportBottom, true)
		...
		draw.SimpleTextOutlined( language.GetPhrase("MW2_CGAME_SB_DEATHS"), "WaW_Scoreboard_Headers", barRight - CoDHUD_S(CFG.OFF_DEATHS), headerY, Color(255,255,255), TEXT_ALIGN_RIGHT, 0, outlined and 1 or 0, Color(0,0,0) )
		draw.SimpleTextOutlined( language.GetPhrase("MW2_CGAME_SB_ASSISTS"), "WaW_Scoreboard_Headers", barRight - CoDHUD_S(CFG.OFF_ASSISTS), headerY, Color(255,255,255), TEXT_ALIGN_RIGHT, 0, outlined and 1 or 0, Color(0,0,0) )
	...
	for _, fac in ipairs(groups) do
		...
		draw.SimpleTextOutlined( label, "WaW_Scoreboard_Text", x + iconSize + textOffset, stripY + iconSize / 2, Color(255,255,255), 0, 1, outlined and 1 or 0, Color(0,0,0) )
...
local function weaponinfo(...)
	...
	local MAT_ALT  = {
		["grenade"] = Material(hudtype .. "/hud/hud_grenade_launcher_dpad.png", "smooth mips"),
	...
	DrawSqueezedText(grenadeCount, "WaW_Res_3D", anchorX + (iH * 0.9), anchorY + (iW * 0.4), textcol, 0, 0, 2)
    ...
    if clip >= 0 then
        ...
        if reserve >= 1000 then
            DrawSqueezedText(reserve, "WaW_Res_3D", barX + barW + CoDHUD_SX(CFG.RES4_X), barY + CoDHUD_SY(CFG.RES4_Y), resCol, CoDHUD_S(-2.5), CoDHUD_S(-2.5), 2)
        elseif reserve >= 100 then
            DrawSqueezedText(reserve, "WaW_Res_3D", barX + barW + CoDHUD_SX(CFG.RES3_X), barY + CoDHUD_SY(CFG.RES3_Y), resCol, CoDHUD_S(-2.5), CoDHUD_S(-2.5), 2)
        else
            DrawSqueezedText(reserve, "WaW_Res_3D", barX + barW + CoDHUD_SX(CFG.RES_X), barY + CoDHUD_SY(CFG.RES_Y), resCol, CoDHUD_S(0), CoDHUD_S(0), 2)
        end
    end
    ...
    if altType ~= -1 and altType ~= primType and altType ~= game.GetAmmoID("Grenade") then
        ...
        DrawSqueezedText(altCount, "WaW_Ammo_Alt", CoDHUD_SX(CFG.ALT_TEXT_X), CoDHUD_SY(CFG.ALT_TEXT_Y), altCol, CFG.ALT_TEXT_SQ, CFG.ALT_TEXT_SQ1, 2)
    end
    ...
    if clip >= 0 and maxClip > 0 and not reloading then
        ...
        if statText ~= "" then
            ...
            draw.SimpleTextOutlined(statText, "WaW_Stat_Font", cx + CoDHUD_SX(2), cy + CoDHUD_SY(2), finalCol, 1, 1, 1.5, Color(0, 0, 0, finalCol.a * 0.8))
        end
    end
end
